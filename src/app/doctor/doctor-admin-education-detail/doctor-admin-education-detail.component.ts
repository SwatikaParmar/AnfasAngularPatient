...
@Component({
  selector: 'app-doctor-admin-education-detail',
  templateUrl: './doctor-admin-education-detail.component.html',
  styleUrls: ['./doctor-admin-education-detail.component.css']
})
export class DoctorAdminEducationDetailComponent {
detail: any;
  patientList: any[] = [];
