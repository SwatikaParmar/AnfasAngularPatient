...
@Component({
  selector: 'app-appointment-chat-list',
  templateUrl: './appointment-chat-list.component.html',
  styleUrls: ['./appointment-chat-list.component.css']
})
export class AppointmentChatListComponent {
  senderId: string = '';
  receiverId: string = '';
  chatHistory: any[] = [];
  rootUrl: any;
