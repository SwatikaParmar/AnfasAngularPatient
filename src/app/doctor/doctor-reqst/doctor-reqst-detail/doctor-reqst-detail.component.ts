...
@Component({
  selector: 'app-doctor-reqst-detail',
  templateUrl: './doctor-reqst-detail.component.html',
  styleUrls: ['./doctor-reqst-detail.component.css']
})
export class DoctorReqstDetailComponent {
detail: any;
  patientList: any[] = [];
