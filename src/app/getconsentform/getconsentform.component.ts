...
@Component({
  selector: 'app-getconsentform',
  templateUrl: './getconsentform.component.html',
  styleUrls: ['./getconsentform.component.css']
})
export class GetconsentformComponent implements OnInit {
  Mrn: string = '';
